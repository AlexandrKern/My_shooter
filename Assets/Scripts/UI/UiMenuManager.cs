...
public class UiMenuManager : UiBase
{
   ...
   [SerializeField] private Image _notificationScreen;
    ...
    private void SetTextStatsGame()
    {
        ...
        _enemyDeathCountText.text = $"Óíè÷òîæåíî\n" +
            $"ìóòàíòîâ: {DataPlayer.GetEnemyDeathCount("mutant")}\n" +
            $"âàìïèðîâ: {DataPlayer.GetEnemyDeathCount("vampire")}\n" +
            $"îðêîâ: {DataPlayer.GetEnemyDeathCount("warrok")}";
    }
